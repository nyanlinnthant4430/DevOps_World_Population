...
/**
 * Report 11:
 * The top N populated capital cities in a given continent.
 * Columns:
 *  - Name
 *  - Country
 *  - Population
...
public class ReportTopNCapitalCitiesContinent {
    ...
    private static final Logger LOGGER =
            Logger.getLogger(ReportTopNCapitalCitiesContinent.class.getName());
    ...
    public static void generateReport(Connection con, String continent, int n) {
        try {
            ...
            String header = String.format(
                    "\n--- Top %d Capital Cities in Continent: %s ---",
                    n, continent
            );
            LOGGER.info(header);
            ...
            LOGGER.log(Level.SEVERE,
                    "Error generating TopNCapitalCitiesContinent report", e);
        }
    }
}
