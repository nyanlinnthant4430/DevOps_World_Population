...
public class FeatureReportCitiesByCountry {
    ...
    public static void generateReport(Connection con, String countryName) {
        try {
            ...
            System.out.println("Cities in Country: " + countryName);
            System.out.println(table.render());

        } catch (Exception e) {
            System.out.println("Error generating country city report: " + e.getMessage());
        }
    }
}
