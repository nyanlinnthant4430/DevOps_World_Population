...
public class FeatureReportTopNCitiesCountry {

    public static void generateReport(Connection con, String countryName, int n) {
        try {
            ...
            System.out.println("Top " + n + " Cities in Country: " + countryName);
            System.out.println(table.render());

        } catch (Exception e) {
            System.out.println("Error generating Top N country city report: " + e.getMessage());
        }
    }
}
